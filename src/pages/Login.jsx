...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center py-20 min-h-screen bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: "url('/background5.jpg')" }}>
      ...
      <div className="bg-gray-900 p-8 rounded-lg shadow max-w-md w-full border border-teal-500/20 relative z-10">
        ...
        <p className="text-sm text-gray-400 mt-4">
          Don't have an account? <Link to="/signup" className="text-teal-400 hover:text-cyan-300">Sign up</Link>
        </p>
