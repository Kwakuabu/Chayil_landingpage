...
export default function Signup() {
  ...
  const handleGoogleSignup = async () => {
    ...
    if (result.success) {
      navigate('/client-dashboard'); // or another page if needed
    } else {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      />
      {/* Main content */}
      <div className="flex justify-center items-center py-20 min-h-screen relative z-10">
        <div className="bg-gray-900 p-8 rounded-lg shadow max-w-md w-full border border-teal-500/20">
