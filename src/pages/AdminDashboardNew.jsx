...
import { FaUsers, FaExclamationTriangle, FaCheckCircle, FaBolt, FaUserPlus, FaFileAlt, FaShieldAlt, FaSearch, FaCog, FaExclamationCircle } from 'react-icons/fa';
          ...
          >
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-gray-400 mt-2">Welcome back, {user?.name || 'Admin'}</p>
              </div>
              <button
                onClick={logout}
