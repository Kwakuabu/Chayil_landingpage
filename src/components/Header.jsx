...
export default function Header() {
  ...
  return (
    <header className={`${isDark ? 'bg-gray-900 text-white' : 'bg-white text-black'} shadow-lg transition-colors duration-300 relative z-50`}>
      <div className="max-w-6xl mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <img src={`${import.meta.env.BASE_URL}images/logo.jpg`} alt="Chayil SecureX Logo" className="h-10 w-auto mr-2 rounded-full" />
